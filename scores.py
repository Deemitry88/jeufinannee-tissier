...
def show_score_window():
    ...
    if score > 0:
        ...
        L = Label(fen, text="Entrez votre pseudo:", width=35, fg="black", bg="white")
        L.place(x=20, y=20)
        E = Entry(fen)
        E.place(x=280, y=20)
        E.focus()
        ...
        L = Label(fen1, text="Entrez vous dans la légende ?", width=25, fg="black", bg="white")
        L.place(x=20, y=20)
        L1 = Label(fen1, text="Surnom", width=10, fg="black", bg="white")
        L1.place(x=210, y=20)
        L2 = Label(fen1, text="temps", width=8, fg="black", bg="white")
        L2.place(x=300, y=20)
        L1.config(text=texteSurnom)
        L2.config(text=score)
        L3 = Label(fen1, text="TOP Scores", width=22, fg="black", bg="white")
        L3.place(x=20, y=50)
        L4 = Label(fen1, text="Vos meilleurs scores.", width=22, fg="black", bg="white")
        L4.place(x=250, y=50)
        ...
        T_labels = []
        for i in range(5):
            S = Label(fen1, text=str(i + 1), width=3, fg="white", bg="black")
            S.place(x=20, y=80 + i * 30)
            N = Label(fen1, text="", width=12, fg="white", bg="black")
            N.place(x=50, y=80 + i * 30)
            T = Label(fen1, text="", width=4, fg="white", bg="black")
            T.place(x=143, y=80 + i * 30)
            S_labels.append(S)
            N_labels.append(N)
            T_labels.append(T)
        # Affichage des meilleurs scores du joueur
        S11 = Label(fen1, text="1", width=3, fg="white", bg="black")
        S11.place(x=250, y=80)
        S12 = Label(fen1, text="2", width=3, fg="white", bg="black")
        S12.place(x=250, y=110)

        N11 = Label(fen1, text="", width=12, fg="white", bg="black")
        N11.place(x=280, y=80)
        N12 = Label(fen1, text="", width=12, fg="white", bg="black")
        N12.place(x=280, y=110)
        T11 = Label(fen1, text="", width=4, fg="white", bg="black")
        T11.place(x=373, y=80)
        T12 = Label(fen1, text="", width=4, fg="white", bg="black")
